                    ...
                    <div class="box_1">
                        ...
                        <div class="boxCenterList clearfix" id="history_list">
                            <ul class="clearfix">
                                <li class="goodsimg">
                                    <a href="#" target="_blank">
                                        <img src="/TT/Public/Home/images/8_thumb_G_1241425513488.jpg" alt="飞利浦9@9v" class="B_blue" />
                                    </a>
                                </li>
                                <li>
                            ...
                            <ul class="clearfix">
                                <li class="goodsimg">
                                    <a href="#" target="_blank">
                                        <img src="/TT/Public/Home/images/9_thumb_G_1241511871555.jpg" alt="诺基亚E66" class="B_blue" />
                                    </a>
                                </li>
                                <li>
            ...
            <div class="AreaR">
                ...
                <div class="box">
                    <div class="box_1">
                        ...
                        <div class="screeBox">
                            <strong>品牌：</strong>
                            <?php if($brand_id): ?><a href="/TT/index.php/Home/Goods/catelist/brand_id/0">全部</a>&nbsp;
                                <?php else: ?>
                                <span>全部</span><?php endif; ?>


                            <?php if(is_array($brand_datas)): foreach($brand_datas as $key=>$d): if($brand_id == $d[id]): ?><a href="#"><span><?php echo ($d["brand_name"]); ?></span></a>&nbsp;
                                    <?php else: ?>
                                    <a href="/TT/index.php/Home/Goods/catelist/brand_id/<?php echo ($d["id"]); ?>"><?php echo ($d["brand_name"]); ?></a>&nbsp;<?php endif; endforeach; endif; ?>
                        </div>
                        <div class="screeBox">
                            <strong>价格：</strong>
                            <?php if($price): ?><a href="/TT/index.php/Home/Goods/catelist/brand_id/<?php echo ($brand_id); ?>/price/0">全部</a>
                                <?php else: ?>
                            <span>全部</span><?php endif; ?>
                            <?php if(is_array($price_datas)): foreach($price_datas as $k=>$d): if($price == $k): ?><a href="#"><span><?php echo ($d); ?></span></a>&nbsp;
                            <?php else: ?>
                            <a href="/TT/index.php/Home/Goods/catelist/brand_id/<?php echo ($brand_id); ?>/price/<?php echo ($k); ?>"><?php echo ($d); ?></a>&nbsp;<?php endif; endforeach; endif; ?>
                        </div>
                    ...
                    <div class="box_1">
                        <h3>
                            ...
                            <form method="GET" class="sort" name="listform">
                                显示方式：
                                <a href="#"><img src="/TT/Public/Home/images/display_mode_list.gif" alt=""></a>
                                <a href="#"><img src="/TT/Public/Home/images/display_mode_grid_act.gif" alt=""></a>
                                <a href="#"><img src="/TT/Public/Home/images/display_mode_text.gif" alt=""></a>&nbsp;&nbsp;

                                <a href="#"><img src="/TT/Public/Home/images/goods_id_DESC.gif" alt="按上架时间排序"></a>
                                <a href="#"><img src="/TT/Public/Home/images/shop_price_default.gif" alt="按价格排序"></a>
                                <a href="#"><img src="/TT/Public/Home/images/last_update_default.gif" alt="按更新时间排序"></a>
                        ...
                        <form name="compareForm" action="" method="post" onsubmit="return compareGoods(this);">
                            <div class="clearfix goodsBox" style="border: medium none; padding: 11px 0pt 10px 5px;">
                                <?php if(is_array($goods_datas)): foreach($goods_datas as $key=>$d): ?><div class="goodsItem">

                                    <a href="<?php echo U('detail','id='.$d[id]);?>"><img src="/TT/Uploads/<?php echo ($d["goods_smallpic"]); ?>" alt="<?php echo ($d["goods_name"]); ?>" class="goodsimg"></a><br />
                                    <p><a href="<?php echo U('detail','id='.$d[id]);?>" title="{$.goods_name}"><?php echo ($d["goods_name"]); ?></a></p>
                                    <font class="market_s">￥<?php echo ($d["goods_mprice"]); ?>元</font><br />
                                    <font class="shop_s">￥<?php echo ($d["goods_price"]); ?>元</font><br />
                                    <a href="#"><img src="/TT/Public/Home/images/goumai.gif"></a> &nbsp;&nbsp;&nbsp;&nbsp;
                                    <a href="#"><img src="/TT/Public/Home/images/shoucang.gif"></a>

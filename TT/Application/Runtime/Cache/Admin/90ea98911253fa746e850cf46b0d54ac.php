    ...
    <body>
        ...
        <div style="font-size: 13px;margin: 10px 5px">
            ...
            <table border="1" width="100%" class="table_a">
                ...
                <tr>
                    ...
                    <td>
                        <select name="pid">
                            ...
                            <?php if(is_array($data)): foreach($data as $key=>$d): ?><option value="<?php echo ($d["id"]); ?>"><?php echo (str_repeat('&nbsp;&nbsp;&nbsp;&nbsp;',$d["level"])); echo ($d["menu_name"]); ?></option><?php endforeach; endif; ?>
                ...
                <tr>
                    <td>控制器名称</td>
                    <td><input type="text" name="menu_controller" /></td>
                </tr>
                <tr>
                    <td>方法名称</td>
